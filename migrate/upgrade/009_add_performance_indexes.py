...
def upgrade(db):
    """Add performance indexes (database-agnostic using IF NOT EXISTS)"""
    ...
    indexes_to_create = [
        ...
        ('ix_strategies_risk_monitoring',
         'CREATE INDEX IF NOT EXISTS ix_strategies_risk_monitoring ON strategies(is_active, risk_monitoring_enabled)'),
    ...
    risk_event_indexes = [
        ('ix_risk_events_strategy',
         'CREATE INDEX IF NOT EXISTS ix_risk_events_strategy ON risk_events(strategy_id)'),
        ('ix_risk_events_triggered_at',
         'CREATE INDEX IF NOT EXISTS ix_risk_events_triggered_at ON risk_events(triggered_at)'),
    ]
